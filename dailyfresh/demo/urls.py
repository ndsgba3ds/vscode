...
from api.views import IndexView,LineView,BarView

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', IndexView.as_view(),name='index'),
    path('api/line', LineView.as_view(),name='line'),
    path('api/bar', BarView.as_view(),name='bar'),
    ...
    path('api/get_comment_by_openId', views.get_comment_by_openId),
