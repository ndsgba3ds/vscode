...
class OrderInfo(BaseModel):
    ...
    user = models.ForeignKey(
        'user.User', verbose_name='用户', on_delete=models.CASCADE,)
    ...
    trade_no = models.CharField(
        max_length=128, default='', verbose_name='支付编号')
...
class OrderGoods(BaseModel):
    ...
    order = models.ForeignKey(
        'OrderInfo', verbose_name='订单', on_delete=models.CASCADE,)
    sku = models.ForeignKey(
        'goods.GoodsSKU', verbose_name='商品SKU', on_delete=models.CASCADE,)
